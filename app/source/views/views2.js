enyo.kind({
	...
	components: [
        {name: "player", kind: "moon.VideoPlayer", src: "movies/big_buck_bunny_720p_50mb.mp4", poster: "assets/video-poster.png", autoplay: true, infoComponents: [
		...
		{name: "panels", kind: "moon.Panels", style:"opacity:0.85", pattern: "activity", classes: "enyo-fit", useHandle: true, components: [
